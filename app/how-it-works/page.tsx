  ...
  return (
    <div className="space-y-8">
      ...
      <section className="section">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white via-emerald-50/80 to-emerald-100 p-8 md:p-10 border-2 border-emerald-100">
          {/* Animated background elements */}
          <div className="pointer-events-none absolute inset-0">
            {/* Animated emergency pulse */}
            <div
              className="absolute top-20 left-20 w-[300px] h-[300px] rounded-full animate-pulse opacity-40"
              style={{ background: 'radial-gradient(closest-side, rgba(16,185,129,0.15), transparent 60%)' }}
            />
            <div
            ...
            <div className="absolute top-10 right-1/4 w-16 h-16 rounded-full bg-emerald-200/40 animate-bounce opacity-60" />
            <div className="absolute bottom-1/4 left-1/4 w-12 h-12 rounded-full bg-emerald-300/40 animate-pulse" />
          ...
          <div className="relative text-center">
            {/* Emergency badge */}
            <div className="inline-flex items-center gap-3 rounded-full bg-white/90 backdrop-blur-sm px-6 py-3 text-sm font-bold shadow-xl ring-1 ring-emerald-200 border border-emerald-100">
              <div className="relative">
                <span className="inline-block h-3 w-3 rounded-full bg-emerald-400 animate-ping absolute" />
                <span className="inline-block h-3 w-3 rounded-full bg-emerald-500" />
              </div>
              <span className="text-emerald-800">🚨 EMERGENCY RESPONSE PLATFORM</span>
            </div>
            ...
            <h1 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-none tracking-tight">
              ...
              <span className="relative">
                ...
                <div className="absolute -inset-2 bg-gradient-to-r from-emerald-200/30 to-emerald-300/30 blur-xl rounded-lg" />
              </span>
              <br />
              <span className="text-3xl md:text-4xl lg:text-5xl text-slate-600">works</span>
            </h1>

            {/* Subtitle */}
            <p className="mt-6 max-w-3xl mx-auto text-lg text-slate-700 leading-relaxed">
              When emergencies strike, <span className="text-emerald-600 font-semibold">every second counts</span>.
              Connect instantly with verified emergency professionals who respond in
              <span className="text-emerald-600 font-semibold"> minutes, not hours</span>.
            </p>
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                onClick={postOrAuth}
                className="group relative overflow-hidden bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-emerald-500/25"
              >
              ...
              <Link
                href="/find-pro"
                className="group bg-white/80 backdrop-blur-sm hover:bg-white text-emerald-700 hover:text-emerald-800 px-8 py-4 rounded-xl font-bold text-lg shadow-xl border-2 border-emerald-200 hover:border-emerald-300 transition-all duration-300 transform hover:scale-105"
              >
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-emerald-200 shadow-lg">
                <div className="text-2xl font-black text-emerald-600">4min</div>
                <div className="text-xs text-slate-600 font-medium">Average Response Time</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-emerald-200 shadow-lg">
                <div className="text-2xl font-black text-emerald-600">24/7</div>
                <div className="text-xs text-slate-600 font-medium">Always Available</div>
              </div>
              <div className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-emerald-200 shadow-lg">
                <div className="text-2xl font-black text-emerald-600">100%</div>
                <div className="text-xs text-slate-600 font-medium">Verified Professionals</div>
              </div>
            </div>
          </div>
        </div>
